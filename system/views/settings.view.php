...
class settings {
	...
	public function permissionsSettings() {
		...
		<div class="alert alert-secondary"><input type="submit" class="submit" value="Save settings" />';
		...
		while ($fetch = $run->fetch_row()) {
			...
			if($current != $fetch[1]){
				...
				echo '</div><div class="alert alert-secondary">';
		...
		echo'</div><div class="alert alert-secondary"><input type="submit" class="submit" value="Save settings" />
