...
<form id="addloan" name="addloan" method="post" action="<?php echo $this->core->conf['conf']['path'] . "/loan/savelend/" . $this->core->item; ?>">
          ...
          <tr>
            <td>
				<table width="768" border="0" cellpadding="5" cellspacing="0">
				  ...
				  <tr>
					<td width="150"><b>Name (Lend Description)</b></td>
					<td>
