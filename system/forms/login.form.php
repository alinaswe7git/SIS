                                ...
                                <div class="card-body">
                                    ...
                                    <form name="login" action="login" method="POST">
                                        <div class="form-group">
                                            <label for="username" class="sr-only">Username/Student number</label>
                                        ...
                                        <input name="submit" id="submit" class="btn btn-block login-btn mb-4"
                                            type="submit" value="submit">
                                    </form>
                                    <a href="<?php //echo $this->core->conf['conf']['path']; ?>/password/recover" class="forgot-password-link">Forgot password?</a>
                                    <!-- <p class="login-card-footer-text">Don't have an account? <a href="<?php //echo $this->core->conf['conf']['path']; ?>/startregistration/create/"
